...
uniform vec3 clamp_color3_in = vec3(0.000000, 0.000000, 0.000000);
uniform vec3 clamp_color3_low = vec3(0.000000, 0.000000, 0.000000);
uniform vec3 clamp_color3_high = vec3(1.000000, 1.000000, 1.000000);
...
void NG_convert_color3_shader(vec3 in1, out surfaceshader out1)
{
    surfaceshader surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    surface_out.color = 1.000000 * in1;
...
void main()
{
    vec3 clamp_color3_out = clamp(clamp_color3_in, clamp_color3_low, clamp_color3_high);
    surfaceshader shader_clamp_color3_out_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_convert_color3_shader(clamp_color3_out, shader_clamp_color3_out_out);
    material material_clamp_color3_out_out = shader_clamp_color3_out_out;
    out1 = vec4(material_clamp_color3_out_out.color, 1.0);
}
