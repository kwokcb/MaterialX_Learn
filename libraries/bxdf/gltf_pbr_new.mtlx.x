...
<materialx version="1.38">
  ...
  <nodedef name="ND_gltf_colorimage" node="gltf_colorimage" version="1.0" isdefaultversion="true" nodegroup="texture2d">
    <input name="file" type="filename" uniform="true" value="" uifolder="Image" doc="The URI of an image file." />
    <input name="default" type="color4" value="0, 0, 0, 0" uifolder="Image" doc="The default value to use if the file reference can not be resolved"/>
    <input name= "uvindex" doc="The index of the texture coordinates" type="integer" uniform="true" value="0" uifolder="Image" doc="The index of the texture coordinates"/>	  
    <input name="pivot" doc="The location of the transformation pivot" type="vector2" value="0, 1" uifolder="Image" doc="The location of the transformation pivot"/>
    <input name="scale" doc="The texture coordinate scale amount" type="vector2" value="1, 1" uifolder="Image"/>
    <input name="rotate" type="float" value="0" unit="degree" unittype="angle" uimin="0" uimax="360" uifolder="Image" doc="The texture coordinate rotate amount"/>
    <input name="offset" doc="The texture coordinate translation amount" type="vector2" value="0, 0" uifolder="Image"/>
    <input name="operationorder" doc="The order to perform transform operations. 0 or SRT performs -pivot scale rotate translate +pivot, and 1 or TRS performs -pivot translate rotate scale +pivot." type="integer" value="1" uifolder="Image"/>
    <input name="uaddressmode" doc="Determines how U coordinates outside the 0-1 range are processed before sampling the image" type="string" uniform="true" value="periodic" enum="constant,clamp,periodic,mirror" uifolder="Image"/>
    <input name="vaddressmode" doc="Determines how V coordinates outside the 0-1 range are processed before sampling the image" type="string" uniform="true" value="periodic" enum="constant,clamp,periodic,mirror" uifolder="Image" doc="Determines how V coordinates outside the 0-1 range are processed before sampling the image"/>
    <input name="filtertype" type="string" uniform="true" value="linear" enum="closest,linear,cubic" uifolder="Image" doc="The type of texture filtering to use"/>
    <input name="color" type="color4" value="1, 1, 1, 1" uifolder="Color" doc="A color factor to multiply by the image value by"/>
    <input name="geomcolor" type="color4" value="1, 1, 1, 1" uifolder="Color" uiname="Geometry Color" doc="A geometric color factor to multiply the image value by"/>
  ...
  <nodedef name="ND_gltf_image_color3_color3_1_0" node="gltf_image" version="1.0" isdefaultversion="true" nodegroup="texture2d">
    ...
    <input name="default" doc="The default value to use if the file reference can not be resolved" type="color3" value="0, 0, 0" />
    <input name= "uvindex" doc="The index of the texture coordinates" type="integer" uniform="true" value="0" />
    <input name="pivot" doc="The location of the transformation pivot" type="vector2" value="0, 1" />
    <input name="scale" doc="The texture coordinate scale amount" type="vector2" value="1, 1" />
    <input name="rotate" type="float" value="0" unit="degree" unittype="angle" uimin="0" uimax="360" />
    <input name="offset" doc="The texture coordinate translation amount" type="vector2" value="0, 0" />
    <input name= "operatororder" doc="The order to perform transform operations. 0 or SRT performs -pivot scale rotate translate +pivot, and 1 or TRS performs -pivot translate rotate scale +pivot." type="integer" value="0" />
    <input name="uaddressmode" doc="Determines how U coordinates outside the 0-1 range are processed before sampling the image" type="string" uniform="true" value="periodic" enum="constant,clamp,periodic,mirror" />
    <input name="vaddressmode" doc="Determines how V coordinates outside the 0-1 range are processed before sampling the image" type="string" uniform="true" value="periodic" enum="constant,clamp,periodic,mirror" />
  ...
  <nodedef name="ND_gltf_image_color4_color4_1_0" node="gltf_image" version="1.0" isdefaultversion="true" nodegroup="texture2d">
    ...
    <input name="default" doc="The default value to use if the file reference can not be resolved" type="color4" value="0, 0, 0, 0" />
    <input name= "uvindex" doc="The index of the texture coordinates" type="integer" uniform="true" value="0" />
    <input name="pivot" doc="The location of the transformation pivot" type="vector2" value="0, 1" />
    <input name="scale" doc="The texture coordinate scale amount" type="vector2" value="1, 1" />
    <input name="rotate" type="float" value="0" unit="degree" unittype="angle" uimin="0" uimax="360" />
    <input name="offset" doc="The texture coordinate translation amount" type="vector2" value="0, 0" />
    <input name= "operatororder" doc="The order to perform transform operations. 0 or SRT performs -pivot scale rotate translate +pivot, and 1 or TRS performs -pivot translate rotate scale +pivot." type="integer" value="1" />
    <input name="uaddressmode" doc="Determines how U coordinates outside the 0-1 range are processed before sampling the image" type="string" uniform="true" value="periodic" enum="constant,clamp,periodic,mirror" />
    <input name="vaddressmode" doc="Determines how U coordinates outside the 0-1 range are processed before sampling the image" type="string" uniform="true" value="periodic" enum="constant,clamp,periodic,mirror" />
    <input name="filtertype" type="string" uniform="true" value="linear" enum="closest,linear,cubic" />
  ...
  <nodegraph name="NG_gltf_image_color4_color4_1_0" nodedef="ND_gltf_image_color4_color4_1_0">
    ...
    <place2d name="place2d" type="vector2">
      <input name="texcoord" type="vector2" nodename="texcoord1" />
      <input name="pivot" doc="The location of the transformation pivot" type="vector2" interfacename="pivot" doc="The location of the transformation pivot" />
      <input name="scale" doc="The texture coordinate scale amount" type="vector2" nodename="invert_scale" />
      <input name="rotate" type="float" nodename="negate_rotate" />
      <input name="offset" doc="The texture coordinate translation amount" type="vector2" nodename="negate_offset" />
      <input name= "operatororder" doc="The order to perform transform operations. 0 or SRT performs -pivot scale rotate translate +pivot, and 1 or TRS performs -pivot translate rotate scale +pivot." type="integer" interfacename="operationorder" />
    </place2d>
  ...
  <nodedef name="ND_gltf_image_float_float_1_0" node="gltf_image" version="1.0" isdefaultversion="true" nodegroup="texture2d">
    ...
    <input name="default" doc="The default value to use if the file reference can not be resolved" type="float" value="0" />
    <input name= "uvindex" doc="The index of the texture coordinates" type="integer" uniform="true" value="0" />
    <input name="pivot" doc="The location of the transformation pivot" type="vector2" value="0, 1" />
    <input name="scale" doc="The texture coordinate scale amount" type="vector2" value="1, 1" />
    <input name="rotate" type="float" value="0" unit="degree" unittype="angle" uimin="0" uimax="360" />
  ...
  <nodedef name="ND_gltf_image_vector3_vector3_1_0" node="gltf_image" version="1.0" isdefaultversion="true" nodegroup="texture2d">
    ...
    <input name="default" doc="The default value to use if the file reference can not be resolved" type="vector3" value="0, 0, 0" />
    <input name= "uvindex" doc="The index of the texture coordinates" type="integer" uniform="true" value="0" />
    <input name="pivot" doc="The location of the transformation pivot" type="vector2" value="0, 1" />
    <input name="scale" doc="The texture coordinate scale amount" type="vector2" value="1, 1" />
    <input name="rotate" type="float" value="0" unit="degree" unittype="angle" uimin="0" uimax="360" />
  ...
  <nodedef name="ND_gltf_normalmap_vector3_1_0" node="gltf_normalmap" version="1.0" isdefaultversion="true" nodegroup="texture2d">
    <input name="file" type="filename" uniform="true" value="" />
    <input name="default" doc="The default value to use if the file reference can not be resolved" type="vector3" value="0.5, 0.5, 1" />
    <input name= "uvindex" doc="The index of the texture coordinates" type="integer" uniform="true" value="0" />
    <input name="pivot" doc="The location of the transformation pivot" type="vector2" value="0, 1" />
    <input name="scale" doc="The texture coordinate scale amount" type="vector2" value="1, 1" />
    <input name="rotate" type="float" value="0" unit="degree" unittype="angle" uimin="0" uimax="360" />
  ...
  <nodedef name="ND_gltf_iridescence_thickness_float_1_0" node="gltf_iridescence_thickness" version="1.0" isdefaultversion="true" nodegroup="texture2d">
    ...
    <input name="default" doc="The default value to use if the file reference can not be resolved" type="vector3" value="0, 0, 0" uifolder="Image" />
    <input name= "uvindex" doc="The index of the texture coordinates" type="integer" uniform="true" value="0" uifolder="Image" />
    <input name="pivot" doc="The location of the transformation pivot" type="vector2" value="0, 0" uifolder="Image" />
    <input name="scale" doc="The texture coordinate scale amount" type="vector2" value="1, 1" uifolder="Image" />
    <input name="rotate" type="float" value="0" uifolder="Image" />
    <input name="offset" doc="The texture coordinate translation amount" type="vector2" value="0, 0" uifolder="Image" />
    <input name="uaddressmode" doc="Determines how U coordinates outside the 0-1 range are processed before sampling the image" type="string" uniform="true" value="periodic" uifolder="Image" enum="constant,clamp,periodic,mirror" />
    <input name="vaddressmode" doc="Determines how U coordinates outside the 0-1 range are processed before sampling the image" type="string" uniform="true" value="periodic" uifolder="Image" enum="constant,clamp,periodic,mirror" />
