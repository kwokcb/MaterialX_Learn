## Steps for C++ / Python Build Jobs

| Job Name | OS | Compiler | Python | Build Flags | Test Flags |
|----------|----|----------|--------|-------------------|------------|
...
| MacOS_Xcode_26_Python313 | macos-26  | xcode, 26.0 | 3.13 | -DCMAKE_EXPORT_COMPILE_COMMANDS=ON | static_analysis |
...
| Windows_VS2022_x64_Python313 | windows-2025 x64 | Default,  | 3.13 | -G "Visual Studio 17 2022" -A "x64" | test_shaders, extended_build_oiio |
...
<li>If (*test_shaders* == 'ON' && runner.os == 'Windows')
    - Install Naga Validator (Windows)
<li>If (*test_shaders* == 'ON' && runner.os == 'Windows')
