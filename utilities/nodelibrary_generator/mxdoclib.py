        ...
        if opts.documentType == 'html':
            ...
            for port in totalList:
                ...
                print('<li class="nav-item" role="presentation">'
                    ...
                    '</li>' % ("active" if makeactive else "", portid, portid, button_label))
                makeactive = False
            print('</ul>')
            print('<br>')
            ...
            for port in totalList:
                ...
                if len(portdoc) > 0:
                    ...
                    print('      <textarea class="form-control form-control-sm" rows="3"')
                ...
                if len(defaultgeomprop) > 0:
                    print('  <div class="form-group row g-1">')
                    print('      <label')
                    print('          class="col-sm-2 col-form-label col-form-label-sm">Geometry Input: </label>')
                    print('      <div class="col-sm-2">')
                ...
                if haveval:
                    ...
                    if (portType == 'boolean'):
                        ...
                        print('  <div class="form-group row g-1">')
                        print('      <label class="col-sm-2 col-form-label col-form-label-sm">Value:</label>')
                        print('      <div class="col-sm-2">')
                        print('          <input type="number" class="form-control form-control-sm" value="%g" disabled>' 
